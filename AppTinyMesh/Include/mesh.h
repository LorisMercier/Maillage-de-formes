...
public:
  ...
  explicit Mesh(const Disque&, const int&);
  explicit Mesh(const Sphere&, const int&, const int&, const bool& =false);
  explicit Mesh(const Tore&, const int&, const int&);
  explicit Mesh(const Capsule&, const int&,const int&,const int&);
  explicit Mesh(const Cylindre&, const int&,const int&, const bool& =true);
